...
public class HomePage extends PageBase {
    ...
    public HomePage verifyCartCount() {
        ...
        getWait().until(ExpectedConditions.visibilityOfElementLocated(locators.BasketIcon()));

        return this;
    }

    public ShoppingCart clickOnGoToBasket() {
        getWait().until(ExpectedConditions.elementToBeClickable(locators.goToBasket()));
